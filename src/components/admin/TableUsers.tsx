...
export default function TableUsers() {
    ...
    const svgSearch = (
        <svg className="w-[15px] h-[15px] flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 376 384">
            <path fill="#000000" d="m267 235l106 106l-32 32l-106-106v-17l-6-6q-39 33-90 33q-58 0-98.5-40.5T0 138.5t40.5-98t98-40.5t98 40.5T277 139q0 51-33 90l6 6h17zm-128 0q40 0 68-28t28-68t-28-68t-68-28t-68 28t-28 68t28 68t68 28z"/>
        </svg>
    )
    ...
    return (
        <div className="flex flex-col items-center w-full min-h-screen overflow-x-hidden">
            ...
            <div className="w-4/5 px-4 md:px-6 lg:px-8 max-w-[calc(100vw-2rem)] md:max-w-[calc(100vw-3rem)] lg:max-w-[calc(100vw-4rem)] mt-24">
